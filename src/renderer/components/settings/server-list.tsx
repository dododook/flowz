...
import { Plus, Edit, Trash2, Server, ChevronDown, Link, Copy, Activity } from 'lucide-react';
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-2">
                    {latencyMap[server.id] !== undefined && (
                         <span className={`text-xs font-medium mr-2 ${getLatencyColor(latencyMap[server.id])}`}>
                  ...
                  {server.protocol?.toLowerCase() === 'shadowsocks' ? (
                    <>
                      <div className="col-span-2">
                        ...
                        <span className="ml-2 font-medium">{server.shadowsocksSettings?.method || 'N/A'}</span>
                      </div>
                    </>
                  ) : (
                    <>
                      <div>
                        ...
                        <span className="ml-2 font-medium">{server.network || 'tcp'}</span>
                      </div>
                      <div>
                        <span className="text-muted-foreground">加密:</span>
                        <span className="ml-2 font-medium">{server.security || 'none'}</span>
                      </div>
                    </>
                  )}
                  <div className="col-span-2">
